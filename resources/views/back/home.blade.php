...
<div class="content-inner home">
    <header class="page-header">
        <div class="container-fluid">
            <div class="title-page no-margin-bottom">{{__('layout.lay.home.title')}}</div>
        </div>
    </header>
    <section>
        <div class="main-body">
...
if(locale == 'th'){
    var rawmessage =['ยินดีต้อนรับเข้าสู่ระบบคุณ {{Auth::user()->full_name}}','ไอพีของคุณคือ {{Request::ip()}}','คูล','ที่นี่คืออะไรมาทำอะไรที่นี่','ที่นี่เป็นพื้นที่ที่รวบรวมข้อมูลงานกิจกรรม','ใช่!!','น่าสนใจจริงๆ','บาย'];
}else{
    var rawmessage =['Welcome {{Auth::user()->full_name}}.','Your IP is {{Request::ip()}}','Cool.',"What's here.",'Here is an area that collects event information.','YES!!','really interesting.','see you.'];
}
